                ...
                <div class="col-9">
                    ...
                    <div class="row add-post">
                        ...
                        <form action="changePage.php" method="post" enctype="multipart/form-data">
                            ...
                            <div class="col mb-4">
                                <input value="" name="password1" type="text" class="form-control" placeholder="Сброс пароля(необязательно)" aria-label="Пароль пользователя">
                            </div>
                            <div class="col mb-4">
                                <input value="" name="password2" type="text" class="form-control" placeholder="Подтвердите пароль" aria-label="Пароль пользователя">
                            </div>
                            ...
                            <div class="form-check">
                                <?php if ($admin == 1):?>
                                    <input name="admin" class="form-check-input" type="checkbox" value="1" id="flexCheckDefault" checked>
                                <?php else:?>
                            ...
                            <div class="col col-6">
                                <button name="btnChangeUser" class="btn back_btn" type="submit">Изменить</button>
                            </div>
                        </form>
                    </div>
